...
export ''_keyedfilebrowser

"""
    ''_keyedfilebrowser(;kwargs...)
...
"""
function ''_keyedfilebrowser(; kwargs...)
        available_props = Symbol[:id, :selectedPath, :files]
        wild_props = Symbol[]
        return Component("''_keyedfilebrowser", "KeyedFileBrowser", "dash_cool_components", available_props, wild_props; kwargs...)
end
